...
(async () => {
    ...
    // 바뀐 표기가 실제로 어딘가에서 측정됐는지 — 안 그러면 이 검사는 공허하게 통과한다.
    // 앞 4개(원시적·중세의·근대 초기·현대의)는 2026-08-18 확률 정보·장비 목록 원본 재대조로 추가된 것.
    // '근대 초기'는 공백 포함 5자로 이 표에서 가장 길다 — 넘침 검사의 최악 후보라 반드시 포함할 것.
    for (const kr of ['원시적', '중세의', '근대 초기', '현대의', '항성간', '다중 우주', '지하 세계']) {
