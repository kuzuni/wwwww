...
const COMBOS = [
    // 밝은 쪽(옛 화법 근처) → 어두운 쪽. 2026-08-20 실측에서 **경계는 top .30 과 .24 사이**다:
    // .30 은 최소속살 35.4%(통과), 한 칸 어두운 .24 는 32.6%(sk_voidLance 미달)로 곧장 깨진다.
    // 그래서 제품값은 '통과하는 것 중 가장 어두운' .30/.05/-.24/.22 로 굳혔다 — 경계를 양옆으로
    // 감싸도록 목록을 남겨 두니, 다음 세션은 이 자를 다시 돌려 경계가 그대로인지부터 볼 것.
    [0.62, 0.42, 0.16, 0.24],
    [0.50, 0.30, 0.04, 0.22],
    [0.38, 0.18, -0.10, 0.22],
    [0.30, 0.05, -0.24, 0.22],   // ← 제품값
    [0.24, 0.02, -0.26, 0.18],
    [0.18, -0.02, -0.28, 0.16],
    [0.12, -0.06, -0.30, 0.14],
];
