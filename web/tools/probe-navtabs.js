...
//
// 판정 항목
//   ① 보이는 탭이 정확히 4개, 라벨 순서가 PVP · 던전 · 소환 · 상점
//   ② data-tab="menu"('방') 버튼이 DOM에 아예 없음
//   ③ 디버그 탭은 기본 숨김(display:none)이고 ?tab=debug 로는 다시 보임 — 훅 보존
//   ④ 각 탭 클릭이 정상 동작: PVP=리그 팝업 · 던전=던전 팝업 · 소환=소환 시트 · 상점=상점 팝업
...
(async () => {
    ...
    check('① 보이는 탭 4개 · 순서 PVP·던전·소환·상점',
        visible.length === 4 && visible.every((v, i) => v.label === EXPECT[i]),
