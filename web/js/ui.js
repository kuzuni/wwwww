...
const UI = {
    ...
    //      타격면 11.6 → 볼 챔퍼 9.0 → 몸통 8.4 → 아이 부풂 9.2 → 8.0
    //      → 🚨 **목 4.6**(y -22.6~-24.5) → 핀이 다시 8.6 으로 벌어졌다가 끝 7.2
    ...
    HAMMER_SVG: `<g class="af-hammer">
        <g transform="translate(55,11) rotate(-20)">
            <g stroke="#14100e" stroke-width="2.2" stroke-linejoin="round" stroke-linecap="round">
                ...
                <path d="M-10.4 0.9 L10.4 0.9 Q11.6 0.9 11.6 -0.6 L11.6 -2.6 L9 -5.6 L8.4 -10.6 Q9.2 -12.8 8.4 -15 L8 -20 L4.6 -22.6 L4.6 -24.5 L8.6 -25.5 L8.6 -30.4 L7.2 -31.6 L-7.2 -31.6 L-8.6 -30.4 L-8.6 -25.5 L-4.6 -24.5 L-4.6 -22.6 L-8 -20 L-8.4 -15 Q-9.2 -12.8 -8.4 -10.6 L-9 -5.6 L-11.6 -2.6 L-11.6 -0.6 Q-11.6 0.9 -10.4 0.9 Z" fill="url(#hmr-steel)"/>
            </g>
            <g stroke="none" pointer-events="none">
                ...
                <path d="M-9.2 -5.4 L9.2 -5.4 L11.5 -2.7 L-11.5 -2.7 Z" fill="#0b0908" opacity=".36"/>
                ...
                <path d="M-8.6 -6.2 L-5.6 -6.2 L-5.6 -19.6 L-8.2 -19.6 Z" fill="#fff" opacity=".22"/>
                <!-- 핀 능선: 왼쪽 밝은 면 / 오른쪽 어두운 면이 만나야 '핀'이지 '못'이 아니다 -->
                <path d="M-8.2 -26.1 L-5.6 -26.1 L-5.6 -30.6 L-8.2 -30.2 Z" fill="#fff" opacity=".28"/>
                <path d="M4.4 -26.1 L8.2 -26.1 L8.2 -30.2 L4.4 -30.6 Z" fill="#000" opacity=".26"/>
                <!-- 자루 나뭇결 하이라이트 -->
