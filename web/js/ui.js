...
const UI = {
    ...
    // ⚠️ 조형은 맬릿이 아니라 **대장간 크로스핀 해머**여야 한다(비평가 ⓒ). 맬릿과 갈리는 신호는
    //    크기가 아니라 **윤곽의 비대칭**이다: 아래가 제일 넓은 타격면(반폭 10.6) → 볼에서 한 단
    //    꺾여 들어가고(8.4) → 자루가 지나는 아이에서 다시 부풀었다가(9.7) → 위로 갈수록 급히
    ...
    HAMMER_SVG: `<g class="af-hammer">
        <g transform="translate(55,14) rotate(-20)">
            <g stroke="#14100e" stroke-width="2.2" stroke-linejoin="round" stroke-linecap="round">
                ...
                <path d="M6 -16.8 L38 -17.2 Q41.6 -17.25 42 -18.2 Q44 -19 46.2 -17.6 Q48.4 -16 48.4 -12.6 Q48.4 -9.2 46.2 -7.6 Q44 -6.2 42 -7 Q41.6 -7.95 38 -8 L6 -8.4 Z" fill="url(#hmr-wood)"/>
                <!-- 가죽 그립 -->
                <path d="M30 -17.1 L38 -17.2 Q41.6 -17.25 42 -18.2 Q44 -19 46.2 -17.6 Q48.4 -16 48.4 -12.6 Q48.4 -9.2 46.2 -7.6 Q44 -6.2 42 -7 Q41.6 -7.95 38 -8 L30 -8.1 Z" fill="url(#hmr-grip)"/>
                <!-- 머리 = 외곽 한 겹. 아래(타격면) → 볼 단 → 아이 부풂 → 크로스핀 쐐기 -->
                <path d="M-9.4 0.9 L9.4 0.9 Q10.6 0.9 10.6 -0.5 L10.6 -6.6 L8.4 -8.8 L8.4 -10.4 Q9.7 -12.6 8.4 -14.8 L8.4 -17.8 L6.4 -21.4 L3.2 -29.6 Q2.9 -31 1.6 -31 L-1.6 -31 Q-2.9 -31 -3.2 -29.6 L-6.4 -21.4 L-8.4 -17.8 L-8.4 -14.8 Q-9.7 -12.6 -8.4 -10.4 L-8.4 -8.8 L-10.6 -6.6 L-10.6 -0.5 Q-10.6 0.9 -9.4 0.9 Z" fill="url(#hmr-steel)"/>
            </g>
            <g stroke="none" pointer-events="none">
                <!-- 타격면: 두들겨 닳아 밝은 띠 + 그 위 챔퍼 그늘. 이 두 줄이 '치는 쪽'을 지정한다 -->
                <path d="M-9.5 -1.4 L9.5 -1.4 L9.5 -0.5 Q9.5 0.4 8.6 0.4 L-8.6 0.4 Q-9.5 0.4 -9.5 -0.5 Z" fill="#eef3f8" opacity=".55"/>
                <path d="M-10 -3.4 L10 -3.4 L10 -1.9 L-10 -1.9 Z" fill="#0b0908" opacity=".34"/>
                <!-- 볼 단 그늘 — 머리가 아래에서 한 번 꺾여 들어간 것을 읽히게 -->
                <path d="M-10.2 -6.8 L10.2 -6.8 L8.5 -8.9 L-8.5 -8.9 Z" fill="#0b0908" opacity=".3"/>
                <!-- 아이(자루 구멍) 그늘 — 자루가 머리를 관통한 것으로 읽히는 유일한 단서 -->
                <path d="M4.4 -16.2 L8.3 -15.9 L8.3 -9.3 L4.4 -9 Z" fill="#0b0908" opacity=".28"/>
                <!-- 왼쪽 림라이트: 몸통 → 아이 → 쐐기 면까지 한 줄로 이어 금속 원통감을 만든다 -->
                <path d="M-9.3 -6.4 L-7.2 -6.4 L-7.2 -0.4 L-9.3 -0.4 Z" fill="#fff" opacity=".26"/>
                <path d="M-7.6 -9.1 L-5.8 -9.1 L-5.8 -17.6 L-7.6 -17.6 Z" fill="#fff" opacity=".2"/>
                <path d="M-5.8 -21.4 L-4.1 -21.4 L-1.9 -29.4 L-3.3 -29.6 Z" fill="#fff" opacity=".24"/>
                <!-- 쐐기 오른쪽 어두운 면 — 두 면이 만나 능선이 서야 '핀'이지 '못'이 아니다 -->
                <path d="M4.6 -21.4 L6.2 -21.4 L3 -29.6 L1.8 -29.4 Z" fill="#000" opacity=".24"/>
                <!-- 자루 나뭇결 하이라이트 -->
                <path d="M7 -16 L29 -16.3 L29 -14.4 L7 -14.1 Z" fill="#fff" opacity=".16"/>
                <!-- 그립 감개: 어두운 줄만 그리면 이미 어두운 가죽에 묻힌다(예전 0.84px 는 전 프레임에서
                     안 보였다). 어두운 줄 + 그 옆 밝은 가죽 능선을 짝지어 폭 1.7유닛(≈1.2px)으로 준다 -->
                <g fill="#080504" opacity=".6">
                    <path d="M33 -17.14 L34.7 -17.16 L34.7 -8.06 L33 -8.04 Z"/>
                    <path d="M38.6 -17.21 L40.3 -17.23 L40.3 -7.99 L38.6 -7.97 Z"/>
                </g>
                <g fill="#a67c58" opacity=".55">
                    <path d="M34.7 -17.16 L35.8 -17.17 L35.8 -8.05 L34.7 -8.06 Z"/>
                    <path d="M40.3 -17.23 L41.4 -17.24 L41.4 -7.98 L40.3 -7.99 Z"/>
                </g>
            </g>
        </g>
    </g>`,
    playAnvilStrike(done) {
        ...
        for (let h = 0; h < 3; h++) {
            ...
            for (let i = 0; i < n; i++) {
                ...
                const d = U.rand(20, 40) * [1, 1.28, 1.8][h];    // viewBox 단위(상판 폭 83)
