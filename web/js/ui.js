...
const UI = {
    ...
    HAMMER_SVG: `<g class="af-hammer">
        <g transform="translate(55,14) rotate(-20)">
            <g stroke="#14100e" stroke-width="2.2" stroke-linejoin="round" stroke-linecap="round">
                ...
                <path d="M6 -17.2 L47 -17.6 Q50.6 -17.65 51 -18.6 Q53 -19.4 55.4 -18 Q58 -16.3 58 -12.8 Q58 -9.3 55.4 -7.6 Q53 -6.2 51 -7 Q50.6 -7.95 47 -8 L6 -8.4 Z" fill="url(#hmr-wood)"/>
                <!-- 가죽 그립 -->
                <path d="M38 -17.5 L47 -17.6 Q50.6 -17.65 51 -18.6 Q53 -19.4 55.4 -18 Q58 -16.3 58 -12.8 Q58 -9.3 55.4 -7.6 Q53 -6.2 51 -7 Q50.6 -7.95 47 -8 L38 -8.1 Z" fill="url(#hmr-grip)"/>
                <!-- 머리 = 외곽 한 겹. 타격면 → 볼 챔퍼 → **평행 몸통** → 아이 부풂 → 짧고 뭉툭한 크로스핀 -->
                <path d="M-8.6 0.9 L8.6 0.9 Q9.4 0.9 9.4 -0.4 L9.4 -3.8 L8 -5.6 L8 -10.6 Q10.2 -12.8 8 -15 L8 -20 L5.4 -21.6 L5.4 -23.2 L7.2 -25.2 L4.2 -30.4 Q4 -31.6 2.8 -31.6 L-2.8 -31.6 Q-4 -31.6 -4.2 -30.4 L-7.2 -25.2 L-5.4 -23.2 L-5.4 -21.6 L-8 -20 L-8 -15 Q-10.2 -12.8 -8 -10.6 L-8 -5.6 L-9.4 -3.8 L-9.4 -0.4 Q-9.4 0.9 -8.6 0.9 Z" fill="url(#hmr-steel)"/>
            </g>
            <g stroke="none" pointer-events="none">
                ...
                <path d="M-9.3 -2.4 L9.3 -2.4 L9.3 -0.4 Q9.3 0.4 8.5 0.4 L-8.5 0.4 Q-9.3 0.4 -9.3 -0.4 Z" fill="#eef3f8" opacity=".55"/>
                <path d="M-9.4 -4.6 L9.4 -4.6 L8.6 -2.6 L-8.6 -2.6 Z" fill="#0b0908" opacity=".34"/>
                ...
                <path d="M-8.8 -5.8 L-5.8 -5.8 L-5.8 -19.6 L-8.8 -19.6 Z" fill="#fff" opacity=".22"/>
                <!-- 핀 능선: 왼쪽 밝은 면 / 오른쪽 어두운 면이 만나야 '핀'이지 '못'이 아니다 -->
                <path d="M-6.9 -25.4 L-5 -25.4 L-3.2 -30.2 L-4.6 -30.4 Z" fill="#fff" opacity=".26"/>
                <path d="M4 -25.4 L6.9 -25.4 L4.6 -30.4 L3.2 -30.2 Z" fill="#000" opacity=".24"/>
                <!-- 자루 나뭇결 하이라이트 -->
    ...
    playAnvilStrike(done) {
        ...
        fx.innerHTML = `<defs>
            ...
            //    그래서 섬광을 **머리 실루엣 밖(|x| > 10.5)에서 시작하는 좌우 두 조각**으로 쪼갠다.
            //    빛은 접촉선을 따라 옆으로 새어 나오고, 머리 위에는 아무것도 얹히지 않는다.
            + [0, 1, 2].map(h => [-1, 1].map(sx => `<path class="af-star s${h}"`
                + ` d="M${hx(h) + sx * 26} ${hy(h)}`
                + ` Q${hx(h) + sx * 15} ${hy(h) - 1.4} ${hx(h) + sx * 10.5} ${hy(h) - 4}`
                + ` L${hx(h) + sx * 10.5} ${hy(h) + 3.2}`
                + ` Q${hx(h) + sx * 15} ${hy(h) + 1} ${hx(h) + sx * 26} ${hy(h)} Z"/>`).join('')).join('')
            ...
            + [0, 1, 2].map(h => `<ellipse class="af-core c${h}" cx="${hx(h)}" cy="${hy(h)}" rx="11.5" ry="2.9"/>`).join('');
        btn.appendChild(fx);
