    ...
    HAMMER_SVG: `<g class="af-hammer">
        <g transform="translate(55,14) rotate(-20)">
            <g stroke="#14100e" stroke-width="2.2" stroke-linejoin="round" stroke-linecap="round">
                ...
                <path d="M-8.6 0.9 L8.6 0.9 Q9.4 0.9 9.4 -0.4 L9.4 -3.8 L8 -5.6 L8 -10.6 Q10.2 -12.8 8 -15 L8 -24 L4.6 -29 Q4.2 -30.6 2.6 -30.6 L-2.6 -30.6 Q-4.2 -30.6 -4.6 -29 L-8 -24 L-8 -15 Q-10.2 -12.8 -8 -10.6 L-8 -5.6 L-9.4 -3.8 L-9.4 -0.4 Q-9.4 0.9 -8.6 0.9 Z" fill="url(#hmr-steel)"/>
            </g>
            <g stroke="none" pointer-events="none">
                ...
                <path d="M-8.8 -5.8 L-5.8 -5.8 L-5.8 -20 L-8.8 -20 Z" fill="#fff" opacity=".22"/>
                <!-- 핀 능선: 왼쪽 밝은 면 / 오른쪽 어두운 면이 만나야 '핀'이지 '못'이 아니다 -->
                <path d="M-6.6 -24.2 L-4.4 -24.2 L-2.4 -30 L-3.9 -30.2 Z" fill="#fff" opacity=".26"/>
                <path d="M3.6 -24.2 L6.6 -24.2 L3.9 -30.2 L2.4 -30 Z" fill="#000" opacity=".24"/>
                <!-- 자루 나뭇결 하이라이트 -->
