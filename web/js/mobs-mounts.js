...
(function (root) {
    ...
    (function () {
        ...
        var q = rideQuad({ c: C, body: [11, 10, 21], legH: 12, legW: 3, legC: C, seat: 21,
            ...
            tackZ: -1,
            extra: [
                { box: [5, 10, 5], at: [0, 23, 6], c: C },
                { box: [7, 4, 6], at: [0, 22, 3], c: D },                       // 앞 혹
                { box: [2, 2, 1], at: [-1.6, 30, 5], parent: 'head', c: C },
                { box: [2, 2, 1], at: [1.6, 30, 5], parent: 'head', c: C },
    ...
    (function () {
        ...
        M['Dino'] = rideQuad({ c: G, body: [12, 12, 20], legH: 8, legW: 4, legC: G, seat: 18,
            ...
            extra: [
                { box: [6, 7, 6], at: [0, 19, 7], c: G },                       // 목
                { box: [2, 2, 9], at: [0, 26, 12], parent: 'head', c: D },       // 볏
