    ...
    (function () {
        ...
        M['bat'] = {
            cell: 0.05, fly: true, parts: [
                // 발 — y 1 → 3. 종전엔 발 윗면(칸 2)이 몸통 밑면(4)에서 **2칸** 떨어져, 박쥐 밑에
                // 작은 상자 둘이 아무 데도 안 붙은 채 따라다녔다(`probe-mob-detached` 실측).
                // 몸통에 물려 **접어 붙인 발**이 되게 올린다 — 나는 박쥐의 자세로도 이쪽이 맞다.
                { box: [2, 2, 3], at: [-1.5, 3, -0.5], c: DK },                      // 접어 붙인 발
                { box: [2, 2, 3], at: [1.5, 3, -0.5], c: DK },
