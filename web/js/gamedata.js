...
const SUBSTATS = [
    ['critCh',    '치명타 확률',            [2.4, 4,    6.4,  8.8,  10.4, 12]],
    ['critDmg',   '치명타 피해',            [16,  26,   42,   58,   70,   80]],
    ['block',     '블록 확률',              [1,   1.7,  2.7,  3.7,  4.4,  5]],
    ['hpRegen',   '체력 재생',              [0.8, 1.3,  2.1,  2.9,  3.5,  4]],
    ['lifesteal', '생명력 흡수',            [4,   6.6,  10.6, 14.6, 17.4, 20]],
    ['dblAtk',    '더블 찬스',              [4,   6.6,  10.6, 14.6, 17.4, 20]],
    ['dmgPct',    '피해',                   [3,   5,    8,    11,   13,   15]],
    ['meleeDmg',  '근접 피해',              [10,  16.5, 26.5, 36.5, 43.5, 50]],
    ['rangedDmg', '원거리 피해',            [3,   5,    8,    11,   13,   15]],
    ['atkSpd',    '공격 속도',              [8,   13,   21,   29,   35,   40]],
    ['skillDmg',  '스킬 피해',              [6,   10,   16,   22,   26,   30]],
    ['skillCd',   '스킬 재사용 대기시간',   [1.4, 2.3,  3.7,  5.1,  6.1,  7]], // 값은 감소량(양수 저장) — 표기 시 '-'
