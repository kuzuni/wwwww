...
const ProChar = {
    ...
    CLIPS: {
        ...
        Death: {
            dur: 1.45, once: true, tracks: {
                'spine.rx': [[0, 0], [0.16, -0.32], [0.38, 0.34], [0.62, 0.22], [0.8, 0.1], [1, 0.06]],
                'spine.ry': [[0, 0], [0.16, 0.28], [0.6, 0.14], [1, 0.1]],
                'spine.rz': [[0, 0], [0.55, 0.1], [0.8, 0.26], [1, 0.22]],     // 무너지는 쪽으로 몸통이 먼저 기운다
                'neck.rx': [[0, 0], [0.16, -0.34], [0.38, 0.3], [0.78, 0.04], [1, 0.16]],
        ...
        Revive: { // 기상: 옆으로 누운 몸을 굴려 무릎으로 세우고 일어선다
            ...
            dur: 0.85, once: true, tracks: {
                ...
                'root.py': [[0, 0.37], [0.3, 0.05], [0.55, -0.22], [0.9, 0.03], [1, 0]],   // 무릎 자세를 거쳐 키가 돌아온다
    ...
    update(R, dt) {
        ...
        if (R.capeMesh) {
            ...
            const walkAmp = (R.state === 'Walking' ? 1.9 : 1) * (1 - flat);
